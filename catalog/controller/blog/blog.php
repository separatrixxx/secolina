	...
	public function index() { 
		...
		if (isset($this->request->get['blog_id'])) {
			...
			if (isset($this->request->get['blogpath'])) {
				...
				$parts = explode('_', $this->model_blog_blog_category->getBlogCategoriesByBlogId($this->request->get['blog_id']));
			}
			...
			if ($category_info) {
				...
				$data['breadcrumbs'][] = array(
					'text' => $category_info['name'],
					'href' => $this->url->link('blog/category', 'blogpath=' . $blog_category_id . $url)
				);
			}
