<?php
if (!class_exists('ControllerAgooLangmarkLangmark', false)) {
	...
	public function index($data) {
        ...
        if (isset($this->data['settings_general']['langmark_widget_status']) && $this->data['settings_general']['langmark_widget_status']) {
			...
			if (SC_VERSION > 15) {
                ...
                if (isset($this->data['settings_general']['langmark_widget_status']) && $this->data['settings_general']['langmark_widget_status'] &&
                	isset($this->data['settingswidget']['langswitch_replace']) && $this->data['settingswidget']['langswitch_replace']
                ) {

	            	if (isset($this->data['settingswidget'])) {
	            		$this->registry->set('lm_settingswidget', $this->data['settingswidget']);
	            	}
                ...
                if (!isset($this->data['settingswidget']['langswitch_replace']) || !$this->data['settingswidget']['langswitch_replace']) {
                    ...
                    if ($run_status) {
						...
						$this->data['langmark'] = $langmark->index($this->data['settingswidget']);

						if (isset($this->data['settingswidget']['cookie_set']) && $this->data['settingswidget']['cookie_set'] !='') {
							setcookie($this->data['settingswidget']['cookie_set'], null, -1, '/', $this->host);
