...
var AjaxBootstrapSelect = function (element, options) {
     ...
     * @type {Object}
     */
    this.options = $.extend(true, {}, $.fn.mf_ajaxSelectPicker.defaults, options);
     ...
     * @type {Selectpicker}
     */
    this.selectpicker = data['mf_selectpicker'];
    ...
    this.locale = $.extend(true, {}, $.fn.mf_ajaxSelectPicker.locale);
...
/**
 * Generates a translated {@link $.fn.mf_ajaxSelectPicker.locale locale string} for a given locale key.
 *
 * @param {String} key
 *   The translation key to use.
 * @param {String} [langCode]
 *   Overrides the currently set {@link $.fn.mf_ajaxSelectPicker.defaults#langCode langCode} option.
 *
 * @return
 ...
 * @return {void}
 */
AjaxBootstrapSelectList.prototype.setStatus = function (status) {return;
    status = status || '';
    if (status.length) {
 ...
 *
 * @param {Object} options
 *   The {@link $.fn.mf_ajaxSelectPicker.defaults options} to pass to the plugin.
 *
 * @returns {jQuery}
 */
$.fn.mf_ajaxSelectPicker = function (options) {
 ...
 *
 * See: {@link $.fn.mf_ajaxSelectPicker.locale}
 * @type {Object}
 */
$.fn.mf_ajaxSelectPicker.locale = {};

/**
 * The default options the plugin will use if none are provided.
 *
 * See: {@link $.fn.mf_ajaxSelectPicker.defaults}
 *
 * @member $.fn.mf_ajaxSelectPicker
 * @property {Object} defaults
 */
$.fn.mf_ajaxSelectPicker.defaults = {
    /**
     * @member $.fn.mf_ajaxSelectPicker.defaults
     * @deprecated Since version `1.2.0`, see: {@link $.fn.mf_ajaxSelectPicker.defaults#preprocessData}.
     ...
     * @deprecated Since version `1.2.0`, see: {@link $.fn.mf_ajaxSelectPicker.defaults#ajax}.
     */
     ...
     * @member $.fn.mf_ajaxSelectPicker.defaults
     * @cfg {Boolean} debug
     * @deprecated Since version `1.2.0`, see: {@link $.fn.mf_ajaxSelectPicker.defaults#log}.
     */
     ...
     * @markdown
     * Provide specific overrides for {@link $.fn.mf_ajaxSelectPicker.locale locale string} translations. Values
     ...
     * @deprecated Since version `1.2.0`, see: {@link $.fn.mf_ajaxSelectPicker.defaults#preserveSelected}.
     */

    /**
     * @member $.fn.mf_ajaxSelectPicker.defaults
     * @cfg placeHolderOption
     * @deprecated Since version `1.2.0`, see: {@link $.fn.mf_ajaxSelectPicker.locale#emptyTitle}.
     */
     ...
     * is initiated. Each time the {@link $.fn.mf_ajaxSelectPicker.defaults#bindEvent bindEvent} is fired, it will cancel the
 ...
 */
$.fn.mf_ajaxSelectPicker.locale['en-US'] = {
    /**
     * @member $.fn.mf_ajaxSelectPicker.locale
...
$.fn.mf_ajaxSelectPicker.locale.en = $.fn.mf_ajaxSelectPicker.locale['en-US'];
