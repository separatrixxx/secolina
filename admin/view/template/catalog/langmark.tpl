...
<div class="page-header-sc">
    <div class="container-fluid">
		<div id="content1" style="border: none;">
			...
			<div class="alert alert-danger warning"><i class="fa fa-exclamation-circle"></i> <?php echo $lm_error_warning; ?>
	...
	<table class="mynotable" style="margin-bottom:20px; background: white; vertical-align: center;">
	  ...
	  <tr>
		<td><?php echo $language->get('entry_xdefault_status'); ?></td>
			<td>
			<div class="input-group">
				<select class="form-control" name="asc_langmark_<?php echo $store_id ?>[xdefault_status]">
