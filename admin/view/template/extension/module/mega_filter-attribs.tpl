...
<ul class="nav nav-tabs">
	...
	<li><a href="#attribs-tab-settings" data-toggle="tab"><?php echo $tab_settings; ?></a></li>
</ul>
<div class="tab-content" id="<?php echo $IDX; ?>_mf-attribs-content">
		...
		<table class="table table-hover" id="<?php echo $IDX; ?>_mf-attribs-table">
			<thead>
				<tr>
					...
					<th class="text-center" width="210"><?php echo $text_options; ?></th>
	...
	<div class="tab-pane" id="attribs-tab-settings" style="padding: 10px 0 0 10px;">
		<?php echo mf_render_btn_group( $text_yes, $text_no, $_attribsName . '[settings][display_in_group]', ! empty( $_attribsValues['settings']['display_in_group'] ) ); ?>
		<?php echo $text_display_in_groups; ?>
	</div>
</div>
