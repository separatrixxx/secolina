	...
	function mf_render_element( $type, $attr ) {
		...
		if( isset( $attr['name'] ) ) {
			...
			if( $type == 'attribs_group' ) {
				$html .= '<br /><br />';
				$html .= mf_render_btn_group( $attr['lang']['text_yes'], $attr['lang']['text_no'], $attr['_name'] . '[display_in_group]', ! empty( $attr['_values']['display_in_group'] ) );
				$html .= ' ' . $attr['lang']['text_display_in_group'];
			}
		...
		$html .= $attr['lang']['text_collapsed_by_default'].':<br>';
		...
		$html .= '<br><label class="control-label"><span data-toggle="tooltip" title="'.$attr['lang']['text_select_deselect_all_button_help'].'">'.$attr['lang']['text_select_deselect_all_button'].'</span></label>:<br>';
		$html .= mf_render_btn_collapsed( $attr['lang']['text_yes'], $attr['lang']['text_no'], $attr['lang']['text_pc'], $attr['lang']['text_mobile'], $attr['_name'] . '[select_deselect_all]', empty( $attr['_values']['select_deselect_all'] ) ? '0' : $attr['_values']['select_deselect_all'] );
		$html .= '</td>';
		...
		$sortOrderValues = array(
			...
			'date_asc'		=> $attr['lang']['text_date_asc'],
			'date_desc'		=> $attr['lang']['text_date_desc'],
		);
