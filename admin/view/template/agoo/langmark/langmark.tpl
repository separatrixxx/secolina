...
display: none;
	...
	<form class="ascp_widgets_form">
        ...
        <input type="hidden" name="ascp_widgets[<?php echo $list_num; ?>][cmswidget]" value="<?php echo $id;?>">
	<table>
		...
		<?php foreach ($languages as $lang) { ?>
			<tr class="noeven">
				...
				<td colspan="2">
							...
							<span class="input-group-addon"><img src="<?php echo $lang['image']; ?>" title="<?php echo $lang['name']; ?>" >&nbsp;&nbsp;<?php echo $lang['name']; ?></span>
	 ...
	 $('.blog_save_new').html('<?php echo $button_save; ?> ('+$('.hremove[value!=\'remove\']').length+')' );
 	 ...
 	 return false; " class="mbutton button_purple"><?php echo $language->get('sc_button_delete'); ?></a>
						...
						<a onclick="
							...
							$.ajax({
							url: 'index.php?route=agoo/blog/ajax_list&token=<?php echo $token; ?>',
							type: 'post',
...
<input type="hidden" name="ascp_widgets[<?php echo $list_num; ?>][cached]" value="0">
...
<table>
    ...
    <!--
     <tr>
              ...
              <select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][cached]">
        ...
        -->
            ...
            <tr>
              <td><?php echo $language->get('entry_langswitch_replace'); ?></td>
              <td>
              	<div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][langswitch_replace]">
                  <?php if (isset($list['langswitch_replace']) && $list['langswitch_replace']) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1" <?php if (!isset($list['langswitch_replace'])) { echo  'selected="selected"'; }  ?>><?php echo $text_enabled; ?></option>
                  <option value="0" <?php if (!isset($list['langswitch_replace'])) {  } else { echo  'selected="selected"'; }  ?>><?php echo $text_disabled; ?></option>
                  <?php } ?>
                </select></div>
              </td>
            </tr>
            ...
            <tr>
              <td><?php echo $language->get('entry_lm_redirect'); ?></td>
              <td>
              <div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][redirect]">
                  <?php if (isset($list['redirect']) && $list['redirect']) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
                  <option value="0" <?php if ((isset($list['redirect']) && !$list['redirect']) || !isset($list['redirect'])) { echo  'selected="selected"'; } ?>><?php echo $text_disabled; ?></option>
                  <?php } ?>
                </select></div>
              </td>
            </tr>
            ...
            <tr>
              <td><?php echo $language->get('entry_lm_autoredirect'); ?></td>
              <td>
              <div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][autoredirect]">
                  <?php if (isset($list['autoredirect']) && $list['autoredirect']) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
                  <option value="0" <?php if ((isset($list['autoredirect']) && !$list['autoredirect']) || !isset($list['autoredirect'])) { echo  'selected="selected"'; } ?>><?php echo $text_disabled; ?></option>
                  <?php } ?>
                </select></div>
              </td>
            </tr>
			...
			<tr>
			<td><?php echo $language->get('entry_bots_status'); ?></td>
			<td>
			<div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][bots_status]">
				<?php if (isset($list['bots_status']) && $list['bots_status']) { ?>
				<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
				<option value="0"><?php echo $text_disabled; ?></option>
				<?php } else { ?>
				<option value="1"><?php echo $text_enabled; ?></option>
				<option value="0" <?php if ((isset($list['bots_status']) && !$list['bots_status']) || !isset($list['bots_status'])) { echo  'selected="selected"'; } ?>><?php echo $text_disabled; ?></option>
				<?php } ?>
			</select></div>
			</td>
			</tr>			
			...
			<tr class="pro-<?php echo $list_num;?>">
		     <td class="left"><?php echo $language->get('entry_bots'); ?></td>
		     <td class="left">
				<div class="input-group"><span class="input-group-addon"></span>
  		     		<textarea class="form-control" style="width: 100%; height: 150px;" name="ascp_widgets[<?php echo $list_num; ?>][bots]"><?php  if (isset($list['bots'])) echo $list['bots']; ?></textarea>
				</div>
		     </td>
		    </tr>
			...
			<tr class="pro-<?php echo $list_num;?>">
<td><?php echo $language->get('entry_autoredirect_langs_ex'); ?></td>
<td><div class="scrollbox">
<?php $class = 'odd'; ?>
<?php foreach ($languages as $lang) { ?>
	<?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
	<div class="<?php echo $class; ?>">
	  <?php if (isset($list['autoredirect_langs_ex']) && in_array($lang['language_id'], $list['autoredirect_langs_ex'])) { ?>
	  <input type="checkbox" name="ascp_widgets[<?php echo $list_num; ?>][autoredirect_langs_ex][]" value="<?php echo $lang['language_id']; ?>" checked="checked" />
	  <?php echo $lang['name']; ?>
	  <?php } else { ?>
	  <input type="checkbox" name="ascp_widgets[<?php echo $list_num; ?>][autoredirect_langs_ex][]" value="<?php echo $lang['language_id']; ?>" />
	  <?php echo $lang['name']; ?>
	  <?php } ?>
	</div>
	<?php } ?>
...
<table>
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" name="tpath" value="widgets/langmark">
				</div>
			</td>
		</tr>
...
<!--
           <tr>
              <td><?php echo $language->get('entry_lm_image_status'); ?></td>
              <td>
              	<div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][image_status]">
                  
				  <?php if (isset($list['image_status']) && $list['image_status']) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1" <?php if (!isset($list['image_status'])) { echo 'selected="selected"'; }  ?>><?php echo $text_enabled; ?></option>
                  <option value="0" <?php if (!isset($list['image_status'])) {   } else { echo 'selected="selected"'; }  ?>><?php echo $text_disabled; ?></option>
                  <?php } ?>
                </select></div>
              </td>
            </tr>
...
<div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][image_status]">
	...
	<?php } else { ?>
	<option value="1"><?php echo $text_enabled; ?></option>
	<option value="0" <?php if ((isset($list['image_status']) && !$list['image_status']) || !isset($list['image_status'])) { echo  'selected="selected"'; } ?>><?php echo $text_disabled; ?></option>
	<?php } ?>
  </select></div>
</td>
</tr>				  
		...
		<tr>
			<td>
				<?php echo $language->get('entry_cookie'); ?>
			</td>
			<td>
				<div class="input-group">
				<input class="form-control" type="text" name="ascp_widgets[<?php echo $list_num; ?>][cookie]" value="<?php if (isset($list['cookie'])) echo $list['cookie']; ?>" size="60" />
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<?php echo $language->get('entry_cookie_set'); ?>
			</td>
			<td>
				<div class="input-group">
				<input class="form-control" type="text" name="ascp_widgets[<?php echo $list_num; ?>][cookie_set]" value="<?php if (isset($list['cookie_set'])) echo $list['cookie_set']; ?>" size="60" />
				</div>
			</td>
		</tr>
...
<div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][doc_ready]">
	...
	<?php } else { ?>
	<option value="1"><?php echo $text_enabled; ?></option>
	<option value="0" <?php if ((isset($list['doc_ready']) && !$list['doc_ready']) || !isset($list['doc_ready'])) { echo  'selected="selected"'; } ?>><?php echo $text_disabled; ?></option>
	<?php } ?>
  </select></div>
</td>
</tr>
   ...
   <?php } ?>
	...
	<tr>
			<td>
			<?php echo $language->get('entry_lm_text_close'); ?>
			</td>

			<td>
				<div style="width: 100%;">
				<div class="input-group marginbottom5px"><span class="input-group-addon"><?php echo strtoupper($lang['code']); ?><br><img src="<?php echo $lang['image']; ?>" title="<?php echo $lang['name']; ?>" ></span>
				<textarea class="form-control" rows="2" cols="70" style="width: 100%;"  id="html_<?php echo $list_num; ?>_<?php echo $lang['language_id']; ?>" name="ascp_widgets[<?php echo $list_num; ?>][lm_text_close][<?php echo $lang['language_id']; ?>]"><?php if (isset($list['lm_text_close'][$lang['language_id']])) echo $list['lm_text_close'][$lang['language_id']]; ?></textarea>
                </div>
				</div>
			</td>
