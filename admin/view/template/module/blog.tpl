...
<div style="margin:5px; float:right;">
   ...
   ?>"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo $button_save; ?></a>
   <?php echo $agoo_save; ?>
</div>
...
function delayer(){
    window.location = 'index.php?route=agoo/blog&<?php echo $token_name; ?>=<?php echo $token; ?>';
}
</script>
								...
								<div style="margin-bottom: 5px;">
								    <a href="#" id="sc_check_common" onclick="
										$.ajax({
											...
											beforeSend: function()
											{
								               $('#check_ver').html('<?php echo $language->get('text_loading_main'); ?>');
											},
										...
										}); return false;" class="markbuttongreen widthbutton sc_button" style=""><?php echo $text_check_ver; ?></a>
								</div>
			...
			<div class="tabcontent" style="padding-left: 220px;" id="list_default">
				...
				<table class="mynotable" style="margin-bottom:20px; background: white; vertical-align: center;">
				    ...
				    <tr class="">
				     ...
				     <td class="left">
				      <div class="input-group">
				      <input class="form-control" type="text" name="ascp_settings[format_date]" value="<?php  if (isset($ascp_settings['format_date'])) echo $ascp_settings['format_date']; else echo $language->get('text_date'); ?>" size="11" />
				      </div>
				     </td>
				    </tr>
					...
					<tr>
						<td class="left">
                          ...
                          <input type="hidden" name="ascp_settings[blog_resize]" value="0">
                          <!--
				          <tr class="pro">
...
<div>
	...
	<tbody>
				          ...
				          <tr>
				              <td><?php echo $entry_seocmscss_status; ?></td>
				              <td>
				              <div class="input-group">
				              <select class="form-control" name="ascp_settings[seocmscss_status]">
				                  <?php if (isset($ascp_settings['seocmscss_status']) && $ascp_settings['seocmscss_status']) { ?>
				                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
				                  <option value="0"><?php echo $text_disabled; ?></option>
				                  <?php } else { ?>
				                  <option value="1"><?php echo $text_enabled; ?></option>
		...
		<table class="table_width_100">
	            ...
	            <tr>
	            	<td class="left td_width"><?php echo $language->get('css_ascp-list-title-size'); ?></td>
	              	<td>
					<div class="input-group">
				        <select class="form-control" name="ascp_settings[css][ascp-list-title-size]">
	            ...
	            <td class="left td_width"><?php echo $language->get('css_ascp-list-title-line'); ?></td>
	              <td>
<div class="input-group">
				              <select class="form-control" name="ascp_settings[css][ascp-list-title-line]">
			           	<?php  foreach ($css_font_size as $num =>$list) { ?>
	            ...
	            <tr>
	            	<td class="left td_width"><?php echo $language->get('css_ascp-list-title-decoration'); ?></td>
	              	<td>
<div class="input-group">
				              <select class="form-control" name="ascp_settings[css][ascp-list-title-decoration]">
	            ...
	            <tr>
	            	<td class="left td_width"><?php echo $language->get('css_ascp-list-title-weight'); ?></td>
	              	<td>
<div class="input-group">
				              <select class="form-control" name="ascp_settings[css][ascp-list-title-weight]">
		...
		<table class="table_width_100">
	            ...
	            <tr>
	            	<td class="left td_width"><?php echo $language->get('css_ascp-list-title-size'); ?></td>
	              	<td>
<div class="input-group">
				              <select class="form-control" name="ascp_settings[css][ascp-list-title-widget-size]">
		           		<?php  foreach ($css_font_size as $num =>$list) { ?>
	            ...
	            <td class="left td_width"><?php echo $language->get('css_ascp-list-title-line'); ?></td>
	              <td>
<div class="input-group">
				              <select class="form-control" name="ascp_settings[css][ascp-list-title-widget-line]">
			           	<?php  foreach ($css_font_size as $num =>$list) { ?>
	            ...
	            <tr>
	            	<td class="left td_width"><?php echo $language->get('css_ascp-list-title-decoration'); ?></td>
	              	<td>
<div class="input-group">
				              <select class="form-control" name="ascp_settings[css][ascp-list-title-widget-decoration]">
			           	<?php  foreach ($css_text_decoration as $num =>$list) { ?>
	            ...
	            <tr>
	            	<td class="left td_width"><?php echo $language->get('css_ascp-list-title-weight'); ?></td>
	              	<td>
<div class="input-group">
				              <select class="form-control" name="ascp_settings[css][ascp-list-title-widget-weight]">
			           	<?php  foreach ($css_font_weight as $num =>$list) { ?>
...
<div style="text-align: center; text-decoration: none; margin-bottom: 5px;">
	<a href="https://opencartadmin.com/doc/index.<?php echo substr(strtolower($config->get('config_admin_language')), 0,2); ?>.html" target="_blank" class="markbuttono widthbutton sc_button asc_blinking" style=""><?php echo $language->get('entry_docs'); ?></a>
</div>
...
<div style="margin-top: 10px;">
    <a href="#" onclick="
		$.ajax({
			url: '<?php echo $url_delete_all_connect; ?>',
			dataType: 'html',
			beforeSend: function()
			{
               $('#id_delete_all_connect').html('<?php echo $language->get('text_loading_main'); ?>');
			},
			success: function(json) {
				$('#id_delete_all_connect').html(json);
			},
			error: function(json) {
			$('#id_delete_all_connect').html('error');
			}
		}); return false;" class="mbutton button_purple sc_button" style=""><?php echo $language->get('url_delete_all_connect_text'); ?></a>
</div>
<div id="id_delete_all_connect"></div>
...
<div style="margin-bottom: 5px;">
    <a href="#" id="sc_check_ver" onclick="
		$.ajax({
			url: '<?php echo $url_check_ver; ?>',
			dataType: 'html',
			beforeSend: function()
		...
		}); return false;" class="markbuttono widthbutton sc_button" style=""><?php echo $text_check_ver; ?></a>
</div>
...
<a href="<?php echo $url_adapter; ?>" class="markbutton widthbutton sc_button"  style="clear:both; margin-top: 6px;"><div><i class="fa fa-refresh" aria-hidden="true"></i></div>
...
<div class="margintop5px">
<a href="<?php echo $language->get('url_download_new_version'); ?>" target="_blank" class="markbutton widthbutton sc_button"  style="clear:both; "><div><i class="fa fa-download" aria-hidden="true"></i></div>
<div style=""><?php echo $language->get('entry_download_new_version'); ?></div></a>
</div>
...
<?php
if (isset($text_blog_update) && $text_blog_update != '' ) { ?>

<div style="font-size: 18px; color: red;"><?php echo $text_blog_update; ?></div>
...
function image_upload(field, thumb) {
	...
	$('#dialog').dialog({
		...
		close: function (event, ui) {
			if ($('#' + field).attr('value')) {
				$.ajax({
					url: 'index.php?route=common/filemanager/image&<?php echo $token_name; ?>=<?php echo $token; ?>&image=' + encodeURIComponent($('#' + field).val()),
					dataType: 'text',
...
var position_type_row = '<?php echo $position_type_row; ?>';
