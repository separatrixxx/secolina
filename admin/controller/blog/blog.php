...
class ControllerBlogBlog extends Controller { 
	...
	private function getList() {
		...
		$data['add'] = $this->url->link('blog/blog/insert', 'user_token=' . $this->session->data['user_token'] . $url, true);
    	...
    	foreach ($results as $result) {
			...
			$data['blogs'][] = array(
				...
				'edit'     => $this->url->link('blog/blog/update', 'user_token=' . $this->session->data['user_token'] . '&blog_id=' . $result['blog_id'] . $url, true)
			);
		}	
		...
		$data['sort_title'] = $this->url->link('blog/blog', 'user_token=' . $this->session->data['user_token'] . '&sort=id.title' . $url, true);
		$data['sort_sort_order'] = $this->url->link('blog/blog', 'user_token=' . $this->session->data['user_token'] . '&sort=i.sort_order' . $url, true);
		$data['sort_date_added'] = $this->url->link('blog/blog', 'user_token=' . $this->session->data['user_token'] . '&sort=i.date_added' . $url, true);
	...
	private function getForm() {
		...
		if (!isset($this->request->get['blog_id'])) {
			$data['action'] = $this->url->link('blog/blog/insert', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('blog/blog/update', 'user_token=' . $this->session->data['user_token'] . '&blog_id=' . $this->request->get['blog_id'] . $url, true);
		}
		...
		if (isset($this->request->post['blog_seo_url'])) {
			...
			$data['blog_seo_url'] = $this->model_blog_blog->getBlogSeoUrls($this->request->get['blog_id']);
		} else {
