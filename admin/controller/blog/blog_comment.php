...
class ControllerBlogBlogComment extends Controller { 
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('blog/blog_comment', 'user_token=' . $this->session->data['user_token'], true));
		}
	...
	private function getList() {
		...
		$data['delete'] = $this->url->link('blog/blog_comment/delete', 'user_token=' . $this->session->data['user_token'], true);
		
		$data['enable'] = $this->url->link('blog/blog_comment/enable', 'user_token=' . $this->session->data['user_token'] . $url, true);
		
		$data['disable'] = $this->url->link('blog/blog_comment/disable', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$pagination->url = $this->url->link('blog/blog_comment', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('blog/blog_comment_list', $data)); 
	}
