...
$_['entry_bots_status'] = 'Статус поисковых роботов <br>на которых не действует <br>перенаправление';
$_['entry_bots'] = 'Токен в user-agent поисковых роботов <br>на которых не действует <br>перенаправление';
$_['entry_autoredirect_langs_ex'] = 'Языки <br>на которых не действует <br>перенаправление';
$_['entry_not_replace'] = 'Не изменять исходное поле';
