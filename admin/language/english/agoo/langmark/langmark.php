...
$_['text_lm_backup_access'] = '<span style="color: red;">You do not have permissions</span>';
$_['text_lm_restore_access'] = '<span style="color: red;">You do not have permissions</span>';

$_['text_lm_settings_no_format'] = '<span style="color: red;">Wrong settings format</span>';
$_['text_lm_json_error'] = '<span style="color: red;">JSON decoding error</span>';
$_['text_lm_error_filetype'] = '<span style="color: red;">Wrong file type</span>';
...
$_['entry_bots_status'] = 'Search robots status <br> on which it does not work <br> redirection';
$_['entry_bots'] = 'Token in user-agent search robots <br> on which does not work <br> redirect';
$_['entry_autoredirect_langs_ex'] = 'Languages <br> on which it does not work <br> redirection';
$_['entry_not_replace'] = 'Not adapting';