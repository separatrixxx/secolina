	...
	public function index() {
		...
		if ($route == 'product/product' && isset($this->request->get['product_id'])) {
			...
			$layout_id = $this->model_catalog_product->getProductLayoutId($this->request->get['product_id']);
				...
				if ($route == 'information/testimonial/info' && isset($this->request->get['testimonial_id'])) {
					$this->load->model('catalog/s_testimonial');
					$layout_id = $this->model_catalog_s_testimonial->getTestimonialLayoutId($this->request->get['testimonial_id']);
				}
		...
		foreach ($modules as $module) {
			...
			if (isset($part[1])) {
				...
				if (isset($part[1])){$setting_info['module_id'] = $part[1];}
