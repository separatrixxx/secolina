...
class ControllerCheckoutSimpleCheckoutLogin extends SimpleController {
    ...
    public function index() {
			...
			$data['SOCNETAUTH2_DATA'] = $this->load->controller('extension/module/socnetauth2/showcode', array("buttons_only"=>1, "str" => "checkout"));
            ...
            /* start socnetauth2 metka */
			$this->_templateData['SOCNETAUTH2_DATA'] = $this->load->controller('extension/module/socnetauth2/showcode', array("buttons_only"=>1, "str" => "checkout"));
			/* end socnetauth2 metka */
