...
class ControllerMailOrder extends Controller {
	...
	public function add($order_info, $order_status_id, $comment, $notify) {
		...
		$data['text_footer'] = $language->get('text_footer');
				...
				if ($this->config->get('module_s_testimonial_status') && $this->config->get('module_s_testimonial_link_order')) {
					$this->load->language('mail/s_testimonial');
					$data['link_testimonial'] = $order_info['store_url'] . "index.php?route=information/testimonial";
				} else {
					$data['link_testimonial'] = '';
				}
