...
class ControllerAccountSimpleRegister extends SimpleController {
    ...
    public function index($args = null) {
            ...
            /* start socnetauth2 metka */$this->_templateData['breadcrumbs'] = array();
			$this->_templateData['SOCNETAUTH2_DATA'] = $this->load->controller('extension/module/socnetauth2/showcode', array("buttons_only"=>1));
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && isset($this->request->post['submitted']) && $this->validate()) {
            ...
            $info['confirmation_code'] = $this->generateUuidV4();
