...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
			...
			$data['SOCNETAUTH2_DATA'] = $this->load->controller('extension/module/socnetauth2/showcode', array("buttons_only"=>1));
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->request->post['confirmation_code'] = $this->generateUuidV4();
            ...
            $this->response->redirect($this->url->link('extension/module/success_register'));
		}
