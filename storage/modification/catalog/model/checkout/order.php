	...
	public function addOrder($data) {
		...
		if (isset($data['totals'])) {
			foreach ($data['totals'] as $total) {
                ...
                $bitrix24login = $this->config->get('config_bitrix24_login');
                $bitrix24password = $this->config->get('config_bitrix24_password');
                $bitrix24domen = $this->config->get('config_bitrix24_domain');
