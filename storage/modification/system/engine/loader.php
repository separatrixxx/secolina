...
final class Loader {
	...
	public function view($route, $data = array()) {
		...
		if ($result && !$result instanceof Exception) {
			...
			$output = $template->render((!defined('HTTP_CATALOG')&&!$this->registry->get('config')->get('template_directory')&&$ext=='tpl'?'default/template/':$this->registry->get('config')->get('template_directory')) . $route, $code);
		}
