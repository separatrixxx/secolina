...
class ControllerMarketingMarketing extends Controller {
	...
	public function add() {
		...
		if ($this->config->get('module_admin_quick_edit_status') && $this->config->get('module_admin_quick_edit_marketing_marketing_status')) {
			foreach ($this->config->get('module_admin_quick_edit_marketing_marketing') as $column => $attr) {
