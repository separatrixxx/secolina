...
$this->load->language('extension/module/mega_filter');
...
$this->load->language('extension/module/mega_filter');
		...
		if ($this->config->get('module_admin_quick_edit_status') && $this->config->get('module_admin_quick_edit_catalog_filters_status')) {
...
$data['text_mf_tooltip'] = $this->language->get('text_mf_tooltip');
