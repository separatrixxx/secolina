	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/download')) {
				...
				if ($this->config->get('module_s_testimonial_status')) {
					$this->load->language('common/s_testimonial');
			
					if ($this->user->hasPermission('access', 'catalog/s_testimonial')) {		
						$catalog[] = array(
							'name'	   => $this->language->get('text_s_testimonial'),
							'href'     => $this->url->link('catalog/s_testimonial', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()		
						);		
					}
				}
      ...
      if ($this->user->hasPermission('access', 'module/complete_seo') && in_array('complete_seo', $this->model_setting_extension->getInstalled('module'))) {
        if ($this->config->get('mlseo_shortcut') == 'top') {
          $data['menus'][] = array(
            'id'       => 'menu-dashboard',
            'icon'	   => 'fa-bar-chart',
            'name'	   => 'Complete SEO',
            'href'     => $this->url->link('module/complete_seo', 'user_token=' . $this->session->data['user_token'], true),
            'children' => array()
          );
