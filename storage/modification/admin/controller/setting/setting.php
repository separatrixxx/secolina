...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_image'])) {
			...
			$data['config_image'] = $this->config->get('config_image');
				...
				if (isset($this->request->post['config_ok'])) {
					$data['config_ok'] = $this->request->post['config_ok'];
				} else {
				...
				if (isset($this->request->post['config_account'])) {
					$data['config_account'] = $this->request->post['config_account'];
				} else {
					$data['config_account'] = $this->config->get('config_account');
				}

				if (isset($this->request->post['config_wishlist'])) {
					$data['config_wishlist'] = $this->request->post['config_wishlist'];
				} else {
					$data['config_wishlist'] = $this->config->get('config_wishlist');
				}

				if (isset($this->request->post['config_compare'])) {
					$data['config_compare'] = $this->request->post['config_compare'];
				} else {
		...
		if (isset($this->request->post['config_bitrix24_login'])) {
				$data['config_bitrix24_login'] = $this->request->post['config_bitrix24_login'];
			} else {
				$data['config_bitrix24_login'] = $this->config->get('config_bitrix24_login');
			}
			if (isset($this->request->post['config_bitrix24_password'])) {
				$data['config_bitrix24_password'] = $this->request->post['config_bitrix24_password'];
			} else {
				$data['config_bitrix24_password'] = $this->config->get('config_bitrix24_password');
			}
			if (isset($this->request->post['config_bitrix24_domain'])) {
				$data['config_bitrix24_domain'] = $this->request->post['config_bitrix24_domain'];
			} else {
				$data['config_bitrix24_domain'] = $this->config->get('config_bitrix24_domain');
			}
