...
class ModelCatalogFilter extends Model {
	public function addFilter($data) {
		...
		foreach ($data['filter_group_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "filter_group_description SET filter_group_id = '" . (int)$filter_group_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', mf_tooltip = '" . $this->db->escape($value['mf_tooltip']) . "'");
		}
...
$filter_group_data[$result['language_id']]['mf_tooltip'] = $result['mf_tooltip'];
		}
